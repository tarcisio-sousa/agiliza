...
# class CheckListPavimentacao(models.Model):
#     # 1 - Identificação
...
#     memorial_descritivo_do_projeto = models.CharField(max_length=250, blank=True, null=True)
...
#     memoria_calculo_e_ou_dimensionamento = models.CharField(max_length=250, blank=True, null=True)
#     declaracao_bem_uso_comum_do_povo = models.CharField(max_length=250, blank=True, null=True)
#     art = models.CharField(max_length=250, blank=True, null=True)
...
#     munutencao_conservacao = models.CharField(max_length=250, blank=True, null=True)
#     existencia_rede_abastecimento_agua = models.CharField(max_length=250, blank=True, null=True)
#     existencia_solucao_esgotamento_sanitario = models.CharField(max_length=250, blank=True, null=True)
#     regime_execucao_obra = models.CharField(max_length=250, blank=True, null=True)
#     manifestacao_orgao_competente_meio_ambiente = models.CharField(max_length=250, blank=True, null=True)
...
#     servico_a_ser_terceirizado = models.CharField(max_length=250, blank=True, null=True)
#     enquadramento_atte_atividade = models.CharField(max_length=250, blank=True, null=True)
#     enquadramento_atte_produto = models.CharField(max_length=250, blank=True, null=True)
#     enquadramento_atte_linha = models.CharField(max_length=250, blank=True, null=True)
#     enquadramento_atte_fonte = models.CharField(max_length=250, blank=True, null=True)
...
#     mat = models.CharField(max_length=250, blank=True, null=True)
