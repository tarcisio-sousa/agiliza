...
urlpatterns = [
    ...
    path(
        'proposta/<int:id>/<slug:situacao>/', views.proposta, name='proposta'),
    path(
        'proposta/documento/<int:id>/',
        views.proposta_documento,
        name='proposta_documento'),
    path(
        'proposta/arquivo/extrato/<int:id>/',
        views.proposta_arquivo_extrato,
        name='proposta_arquivo_extrato'),
    path(
        'proposta/empenhar/<int:id>/',
        views.proposta_empenhar,
        name='proposta_empenhar'),
    path(
        'proposta/excluir/<int:id>/',
        views.proposta_excluir,
        name='proposta_excluir'),
    ...
    path(
        'convenio/aprovar/projeto/<int:id>/',
        views.convenio_aprovar_projeto,
        name='convenio_aprovar_projeto'),
    path(
        'convenio/licitar/projeto/<int:id>/',
        views.convenio_licitar_projeto,
        name='convenio_licitar_projeto'),
    path(
        'convenio/aprovar/licitacao/<int:id>/',
        views.convenio_aprovar_licitacao,
        name='convenio_aprovar_licitacao'),
    path(
        'convenio/recurso/em/conta/<int:id>/',
        views.convenio_recurso_conta,
        name='convenio_recurso_conta'),
    path(
        'convenio/concluir/<int:id>/',
        views.convenio_concluir, name='convenio_concluir'),
    path(
        'convenio/concluir/prestacao/contas/<int:id>/',
        views.convenio_concluir_prestacao_contas,
        name='convenio_concluir_prestacao_contas'),
    path(
        'convenio/excluir/<int:id>/',
        views.convenio_excluir, name='convenio_excluir'),
    path(
        'arquivo/extrato/<int:id>/',
        views.arquivo_extrato, name='arquivo_extrato'),

    path('servicos/', views.servicos, name='servicos'),
    path('servico/', views.servico, name='servico'),
    path(
        'servico/excluir/<int:id>/',
        views.servico_excluir, name='servico_excluir'),
    ...
    path(
        'projeto/<int:projeto_id>/item/',
        views.projeto_item, name='projeto_item'),
    path(
        'projeto/<int:projeto_id>/item/<int:id>/',
        views.projeto_item, name='projeto_item'),
    path(
        'projeto/<int:convenio_id>/controle/',
        views.projeto_controle, name='projeto_controle'),
    path(
        'projeto/controle/<int:controle_id>/item/',
        views.projeto_controle_item, name='projeto_controle_item'),
    ...
    path(
        'itens/alternativas/',
        views.itens_alternativas, name='itens_alternativas'),
    path(
        'item/alternativas/<int:id>/',
        views.item_alternativas, name='item_alternativas'),
    path(
        'item/alternativas/',
        views.item_alternativas, name='item_alternativas'),
    ...
    path(
        'protocolo/resolver/<int:id>/',
        views.protocolo_resolver, name='protocolo_resolver'),
    path(
        'protocolo/excluir/<int:id>/',
        views.protocolo_excluir, name='protocolo_excluir'),
    path(
        'protocolo/dados-bancarios/<int:convenio_id>/',
        views.protocolo_dados_bancarios, name='protocolo_dados_bancarios'),
    path(
        'protocolo/empresa-contratada/<int:convenio_id>/',
