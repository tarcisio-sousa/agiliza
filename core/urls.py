...
urlpatterns = [
    ...
    path('proposta/arquivo/extrato/<int:id>', views.proposta_arquivo_extrato, name='proposta_arquivo_extrato'),
    ...
    path('projeto-controle/<int:id>', views.projeto_controle, name='projeto_controle'),
    path('projeto-controle-item/<int:id>', views.projeto_controle_item, name='projeto_controle_item'),
